...
import subprocess
import threading
# --- [MODIFIED] Import send_from_directory ---
from flask import Flask, render_template, send_from_directory
from flask_socketio import SocketIO, emit

# We must use eventlet for this to work correctly
import eventlet
...
OUTPUT_EXCEL = "vtu_results.xlsx" # <-- Define output file
PYTHON_EXECUTABLE = sys.executable # Get the python from your venv
# ---------------------
...
# --- [NEW] 2. Create the Download Route ---
@app.route('/download')
def download_file():
    ...
    try:
        ...
        # Send the file from the server's directory to the user
...
def handle_start_fetch(message):
    ...
    socketio.start_background_task(target=run_fetcher_script)
...
def run_fetcher_script():
    ...
    print(f"Running command: ['{PYTHON_EXECUTABLE}', '{BACKEND_SCRIPT}']")
    ...
    try:
        ...
        # --- [NEW] Check if file exists and tell UI
